...
void GestionEmploye::on_pushButton_ajouter_clicked()
{
 qDebug();
...
void GestionEmploye::on_pushButton_supp_clicked()
{
...
void GestionEmploye::on_affichem_clicked()
{

    ui->tableView->setModel(e.afficher());
}

void GestionEmploye::on_pushButton_modifier_clicked()
{
    qDebug();
    QString id_e=ui->lineEdit_CIN->text();
    QString nom=ui->lineEdit_NomEmploye->text();
...
void GestionEmploye::on_pb_recher_clicked()
...
void GestionEmploye::afficherStatistiques() {
...
void GestionEmploye::on_pb_pdf_clicked()
...
void GestionEmploye::on_radioButton_NOM_clicked()
{
    QSqlQueryModel *sortedModel = e.trier(2);
    ui->tableView->setModel(sortedModel);
}

/*void GestionEmploye::on_tabWidget_currentChanged(int index)
{

}*/

void GestionEmploye::on_radioButton_2_clicked()
{
    QSqlQueryModel *sortedModel = e.trier(3);
    ui->tableView->setModel(sortedModel);
}

void GestionEmploye::on_pushButton_tentative_clicked()
{
    QSqlQuery query;
...
//void GestionEmploye::incrementNbreEntree() {
    /*QSqlQuery query;
...
void GestionEmploye::on_pushButton_qrcode_clicked()
{
